            ...
            <div className="container mx-auto px-3 max-w-[1104px]">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className=' mb-12 sm:mb-[70px] '>
                        <Image className='mx-auto mt-10' src="/assets/images/webp/homePage/whoAllanImage.webp" width={503} height={603} alt="allan draper" />
                    </div>
                </div>
            </div>
        </div>
