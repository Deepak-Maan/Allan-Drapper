    ...
    <div className='pt-[120px]'>
      <div className='container mx-auto max-w-[1172px] px-4'>
        <div className='flex flex-col items-center justify-center'>
          ...
          <p className='opacity-80 max-w-[601px] pt-9 pb-14 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 text-center'>Eget mattis ac venenatis m. Sem diam facilisi scelerisque tellus suscipit felis a tempus. arius at pulvinar dictum</p>
        </div>
        <Swiper
