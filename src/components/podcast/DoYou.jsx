    ...
    return (
        <div className='bg-doYou lg:py-[168px] md:py-20 sm:py-16 py-12 bg-center bg-cover bg-no-repeat'>
            <div className='container  mx-auto px-3 max-w-[1164px]'>
                <H2 heading="Do you have what it takes to be on The Allan Draper Show?" className="after:bg-yellow max-w-[685px] capitalize text-center mx-auto text-white flex justify-center after:left-1/2 after:-translate-x-1/2 mb-6 sm:mb-[36px]" />
