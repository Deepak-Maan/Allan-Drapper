...
const Companies = () => {
  return (
    <div className='max-w-[1220px] mx-auto px-3 sm:pb-16 pt-8 mb-2'>
      <H2 className="text-center" heading="Companies Allan Founded" />
      <div className="flex flex-wrap xl:gap-16 gap-10  justify-center sm:pt-24 pt-8">
      ...
      <div className='flex justify-center sm:pt-20 pt-4 pb-8 mb-1'>
