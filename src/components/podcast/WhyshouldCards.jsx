    ...
    return (
        <>
            {cards.map((card, index) => (
                <div key={index} className='py-5 px-5 sm:px-10 border border-solid border-offGray h-full max-h-[184px]'>
                    ...
                    <p className='font-bold text-3xl1 sm:text-4xl md:text-4xl1 xl:text-5xl !leading-120 text-lightBlack text-center mt-6'>
                        {card.amount}
                    </p>
                </div>
            ))}
