    ...
    return (
        <>
            <div className='sm:mt-10 mt-7 md:mt-[66px]'>
                <Heading heading="Allan's Brands" className="after:!bg-offBlue text-lightBlack flex justify-center after:left-1/2 after:-translate-x-1/2 mb-6 sm:mb-8 md:mb-[44px]" />
