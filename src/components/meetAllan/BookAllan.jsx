    ...
    return (
        <div className='max-w-[1164px] mx-auto px-3 pt-12 sm:pt-16 md:pt-20 lg:pt-[120px]'>
            ...
            {BooksData.map((section, index) => (
                <div key={index}>
                    <h3 className="xl:pt-14 sm:pt-10 pt-6 xl:mt-1 font-bold text-3xl text-lightBlack sm:pb-6 pb-3 lg:mb-1.5">{section.category}</h3>
                    <div className="flex flex-row items-center justify-center pb-5 sm:pb-8 lg:pb-[60px] flex-wrap">
                        {section.items.map((book, bookIndex) => (
                            <div key={bookIndex} className='xs:w-1/2 w-full md:w-1/3 px-3 pt-4 xs:pt-0'>
                                <div className="max-[500px]:w-full border border-offGray lg:min-h-[376px] sm:min-h-[310px] min-h-[270px] max-[500px]:min-h-[240px] sm:pt-10 pt-6 md:px-6 px-2 flex flex-col items-center hover:shadow-[0px_0px_20px_1px_#00000012]  duration-300">
                                    <Image
                                        src={book.src}
                                        alt={book.title}
                                        width={464}
