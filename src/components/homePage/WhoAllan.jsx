            ...
            <div className="container mx-auto px-3 max-w-[1104px]">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className='flex justify-center lg:justify-start'>
                        <div>
                            <H2 heading="Who is Allan Draper ?" className="text-center lg:text-left after:left-1/2 max-lg:after:-translate-x-1/2 lg:after:left-0" />
                            ...
                            <Image className='sm:pb-10 md:pb-[77px] max-lg:mx-auto' src="/public/assets/images/homePage/webp/allanSignature.webp" width={299} height={79} alt="allan's signature" />
                        </div>
                    </div>
                    <div className=' mb-12 sm:mb-[70px] '>
                        <Image className='mx-auto mt-10' src="/assets/images/homePage/webp/whoAllanImage.webp" width={503} height={603} alt="allan draper" />
                    </div>
                </div>
            </div>
        </div>
