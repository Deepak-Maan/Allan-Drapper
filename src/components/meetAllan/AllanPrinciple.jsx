...
import {  Heart, ScaryPrinciple, Peoples, ThinkingPrinciple } from "../common/Icons";
import { Heading } from "../common/Heading";

const AllanPrinciple = () => {
    return (
        <div className="bg-principle bg-no-repeat bg-cover bg-center">
            <div className="container max-w-[1164px] flex flex-col md:flex-row justify-center items-center md:justify-between mx-auto px-3 relative pt-3 sm:pt-0 h-full  md:h-[70vh] lg:h-[85vh] xl:min-h-[770px] 2xl:h-full">
                <div className="flex flex-col md:flex-row justify-center items-center flex-wrap">
                    <div className="w-[120px] h-[280px] sm:w-[399px] sm:h-[200px] lg:w-[600px] lg:h-[400px] absolute left-[22%] lg:left-[6%]  !bottom-0 bg-yellow rounded-full blur-[130px] z-0 opacity-70 lg:opacity-60 -translate-y-[100%] sm:-translate-y-[200%] md:-translate-y-1/2 translate-x-1/2 sm:-translate-x-[15%]"></div>
                    <Image
                        src="/assets/images/meetAllan/webp/principle.webp"
                        alt="Principle"
                        width={752}
                        height={1103}
                        className="sm:max-w-[400px] md:max-w-[540px] md:absolute bottom-0 -left-[1%] xxs:-left-[14%] md:-left-[7%] lg:left-[-3%] xl:left-0 relative z-40 lg:max-w-[652px] xl:w-[752px] xl:min-h-[755px] sm:max-h-[500px] md:max-h-[600px] object-cover lg:h-[583px]"
                    />

                    <div className="pb-12 sm:pb-14 lg:pb-16 mx-auto xl:pb-[138px] md:absolute right-2 pt-8 sm:pt-20 md:pt-[100px] lg:pt-[140px] xl:pt-[150px]">
                        ...
                        <div className="flex items-center gap-4 pb-6 md:pb-10 lg:pb-16">
                            <div className="relative after:absolute after:w-[2px] after:h-[15px] sm:after:h-12 after:content-[''] after:border-l-2 z-10 after:border-dotted after:border-offBlue after:left-1/2 after:top-[120%]">
                                <span className="relative z-30"><Peoples /></span>
                            </div>
