...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="max-w-[1264px] w-full mx-auto px-3 py-[14.5px] flex items-center justify-between bg-black">
        <Link className="relative z-10" href="/">
          <Image src='/assets/images/podcast/svg/navLogo.svg' alt="Logo" width={215} height={39} />
        </Link>
        <ul
          className={`flex items-center gap-5 z-20 relative sm:gap-[32px] lg:gap-10 duration-300 max-lg:fixed max-lg:w-full max-lg:!min-h-screen max-lg:justify-center max-lg:flex-col max-lg:top-0 max-lg:left-[-105%] max-lg:p-[30px] max-lg:!bg-white ${navBar && "!left-0"
            }`}
        >
          ...
          <li>
            <button className="border border-orange border-solid py-3 px-5">
            Newsletter
            </button>
          </li>
