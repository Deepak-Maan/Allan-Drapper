            ...
            <div className='pt-[50px]'>
                <div className='flex flex-row flex-wrap -mx-3 justify-between'>
                    <div className='w-full lg:w-[53%] px-3'>
                        ...
                        <div className='flex items-center font-medium text-2xl leading-130 mt-5 gap-1'>
                        ...
                        <div className='flex items-center font-medium text-2xl leading-130 mt-3 gap-1'>
