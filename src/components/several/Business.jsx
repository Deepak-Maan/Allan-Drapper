        ...
        return (
                <div className='pt-[110px]'>
                        <div className='container max-w-[1140px] mx-auto px-3'>
                                <div className='flex flex-col min-[1100px]:flex-row gap-8 relative'>
                                        <div className='pt-14 order-2 lg:order-1'>
                                                ...
                                                <div className='mb-[60px]'>
                                                        ...
                                                        <p className='opacity-80 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 max-w-[775px] mb-[60px]'>Stay flexible and persistent, ready to pivot based on market feedback and changing circumstances. By following these steps, you can systematically evaluate your business ideas and focus on the most promising ones, increasing your chances of success.</p>
                                                </div>
                                                <div className='mb-[60px]'>
                                        ...
                                        <div className='w-[330px] order-1 lg:order-2 h-full p-[32px] lg:sticky lg:top-0 border border-offGray '>
                                                ...
                                                <div className='flex items-center gap-[10px] mb-6'>
                                                        <Image src={rightClick} alt='rightClick' />
                                                        <p className='font-medium text-lightBlack opacity-80 text-lg sm:text-xl md:text-2xl leading-130'>Business Description</p>
                                                </div>
                                                <div className='flex items-center gap-[10px] mb-6'>
                                                        <Image src={rightClick} alt='rightClick' />
