  ...
  return (
    <div className='pt-12 sm:pt-16 md:pt-20 lg:pt-[156px]'>
      <div className='container max-w-[1172px] px-4 mx-auto'>
         <div className='flex items-center flex-col lg:flex-row gap-[68px]'>
                <div className=' flex flex-col items-center'>
                        <div className='border border-offGray p-4 max-w-[588px] w-full mb-3'>
                ...
                <Heading className="text-3xl1 sm:text-4xl md:text-4xl1 capitalize flex text-center lg:text-start max-w-[398px] !leading-105 " heading="What You Will Gain from Allan's Coaching"/>
                <div className='flex justify-center lg:justify-start'>
                        <Image src="/assets/images/coaching/webp/gain-man.webp" alt='gainMan' width={484} height={623} className='pt-[40px] md:max-w-[464px] md:h-[623px]'/>
                </div>
                </div>
         </div>
      </div>
