                                ...
                                <div className='flex flex-col lg:flex-row gap-4 md:gap-8 relative'>
                                        <div className=' pt-6 md:pt-14 order-2 lg:order-1'>
                                                ...
                                                <div className='mb-[60px]'>
                                                        <Image src={analyzeMan} alt='analyzeMan' className='w-full md:max-w-[758px] md:h-[393px]' />
                                                        <h4 className='text-lightBlack font-bold text-2xl md:text-2xl1 leading-120 pt-8 pb-4'>Analyze SWOT, get feedback, and prioritize ideas.</h4>
                                                ...
                                                <div className='mb-[60px]'>
                                                        <Image src={navigate} alt='analyzeMan' className='w-full md:max-w-[758px] md:h-[393px]' />
                                                        <h4 className='text-lightBlack font-bold text-2xl md:text-2xl1 leading-120 pt-8 pb-4'>Navigate with Flexibility and Perseverance</h4>
                                        ...
                                        <div className='w-full lg:w-[330px] mx-auto order-1 lg:order-2 h-full p-[32px] xl:sticky xl:top-0 border border-offGray '>
                                                <h5 className='text-lightBlack font-bold text-2xl md:text-2xl1 leading-120 mb-4'>Table of Contents</h5>
                                                <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 gap-6">
