...
const DoYou = () => {
    return (
        <>
            <div className='bg-doYou xl:py-[168px] lg:py-24 md:py-16 sm:py-14 py-12 bg-center bg-cover bg-no-repeat max-w-[1920px] mx-auto xl:max-h-[602px]'>
                <div className='container  mx-auto px-3 max-w-[1164px]'>
                    <Heading heading="Do you have what it takes to be on The Allan Draper Show?" className="after:bg-yellow max-w-[685px] capitalize text-center mx-auto text-white flex justify-center after:left-1/2 after:-translate-x-1/2 mb-6 sm:mb-9" />
