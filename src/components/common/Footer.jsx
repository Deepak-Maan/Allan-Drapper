...
const Footer = () => {
    return (
        <div className='bg-black2 mt-[-1px]'>
            <div className="container mx-auto px-3 py-12 sm:py-14 md:py-16 lg:pt-20 pb-8 max-w-[1164px]">
                    ...
                    <div className='flex justify-between lg:w-[60%] w-full'>
                        <div>
                            <ul className='max-w-[158px] ml-auto'>
                                ...
                                <li className='pb-6'><Link className='footerLinks' href="/portfolio">My Brands</Link></li>
