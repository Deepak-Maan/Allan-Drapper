        ...
        <div className='bg-gray'>
            <div className="max-w-[1164px] px-3 mx-auto pt-12 max-sm:pb-6 sm:pt-14 md:pt-16 lg:pt-12 xl:pt-24">
                <div className='mb-[61px]'>
                    <Heading heading={"Allan’s Unpopular Opinions"} className={"text-center after:left-1/2 after:-translate-x-1/2 after:!bg-lightBlack after:opacity-80 "} />
                </div>
                <div className="flex flex-row flex-wrap items-center lg:justify-start lg:items-start justify-center xl:pt-5 sm:pb-4 md:pb-6 lg:pb-2 xl:pb-14">
                    {CARDDATA.map((card, index) => (
                        <div key={index} className="w-full flex flex-col justify-center items-center sm:items-start sm:justify-start sm:w-1/2 lg:w-1/3 pb-4 sm:pb-10">
                            <Image
                                src={card.image}
                                alt={card.title}
                                width={64}
