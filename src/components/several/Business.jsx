                                ...
                                <div className='flex flex-col lg:flex-row gap-4 md:gap-8 relative'>
                                        <div className=' pt-6 md:pt-14 order-2 lg:order-1'>
                                                ...
                                                <div className=' mb-6 md:mb-[60px]'>
                                                        <Image src="/assets/images/blockdetail/webp/evaluate-man.webp" width={798} height={433} alt='analyzeMan' className=' w-full md:max-w-[798px] md:h-[433px]' />
                                                        <h4 className='text-lightBlack font-bold text-2xl md:text-2xl1 leading-120 pt-3 pb-4'>Evaluate ideas by listing, researching, and assessing feasibility.</h4>
                                                        <p className='opacity-80 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 w-full lg:w-[778px] mb-4'>Having several business ideas is an exciting position to be in, and there are several steps you can take to evaluate and pursue the most promising ones. Start by listing and categorizing your ideas based on industry, market, or other relevant criteria. Conduct initial research for each idea to understand the market demand, competition, and potential customer base, identifying trends and gaps your ideas might fill. Assess the feasibility of each idea by considering the required investment, technical skills, and resources needed, as well as your own expertise and passion for each one. Using a business model canvas for each idea can help you outline key customer segments, channels, and revenue streams.</p>
                                                        <p className='opacity-80 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 mb-4'>1. List your ideas.</p>
                                                        <p className='opacity-80 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 mb-4'>2. Research market demand and competition.</p>
                                                        <p className='opacity-80 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 '>3. Assess feasibility based on investment and skills.</p>
                                                </div>
                                                <div className='mb-[60px]'>
                                                        <Image src="/assets/images/blockdetail/webp/analyze-man.webp" alt='analyzeMan' width={814} height={433} className='w-full md:max-w-[814px] md:h-[433px]' />
                                                        <h4 className='text-lightBlack font-bold text-2xl md:text-2xl1 leading-120 pt-3 pb-4'>Analyze SWOT, get feedback, and prioritize ideas.</h4>
                                                        ...
                                                        <p className='opacity-80 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 max-w-[775px] mb-3'>Develop detailed business plans for these top ideas, outlining your strategy, target market, financial projections, and marketing plan. Validate your idea with a minimum viable product (MVP) or prototype, collecting real-world feedback and iterating based on customer responses. Determine the funding needed for your business and explore options such as personal savings, loans, investors, or crowdfunding. Network with industry professionals and potential partners, and build a team with complementary skills to help execute your business idea. Start with a clear execution plan, set measurable goals, and continuously monitor progress, adapting your strategy as needed. </p>
                                                        <h4 className='text-lightBlack font-bold text-2xl md:text-2xl1 leading-120 pb-4'>Stay adaptable for business success.</h4>
                                                        <p className='opacity-80 text-lightBlack font-medium text-lg sm:text-xl md:text-2xl leading-130 max-w-[775px] mb-6 md:mb-[60px]'>Stay flexible and persistent, ready to pivot based on market feedback and changing circumstances. By following these steps, you can systematically evaluate your business ideas and focus on the most promising ones, increasing your chances of success.</p>
                                                </div>
                                                <div className='mb-6 sm:mb-10 md:mb-[60px]'>
                                                        <Image src="/assets/images/blockdetail/webp/navigate-man.webp" alt='analyzeMan' width={814} height={433} className='w-full md:max-w-[814px] md:h-[433px]' />
                                                        <h4 className='text-lightBlack font-bold text-2xl md:text-2xl1 leading-120 pt-3 pb-4'>Navigate with Flexibility and Perseverance</h4>
                                        ...
                                        <div className='w-full xl:w-[330px] mx-auto order-1 xl:order-2 h-full p-[32px] xl:sticky xl:top-0 border border-offGray '>
                                                ...
                                                <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-1 gap-6">
                                                        <div className='flex items-center justify-start gap-[10px]'>
                                                                <Image src="/assets/images/blockdetail/svg/right-click.svg" alt='rightClick' width={20} height={20}/>
                                                                <p className='font-medium text-lightBlack opacity-80 text-lg sm:text-xl md:text-2xl leading-130'>Executive Summary</p>
                                                        </div>
                                                        <div className='flex items-center gap-[10px] '>
                                                                <Image src="/assets/images/blockdetail/svg/right-click.svg" alt='rightClick' width={20} height={20}/>
                                                                <p className='font-medium text-lightBlack opacity-80 text-lg sm:text-xl md:text-2xl leading-130 text-nowrap'>Business Description</p>
                                                        </div>
                                                        <div className='flex items-center gap-[10px] '>
                                                                <Image src="/assets/images/blockdetail/svg/right-click.svg" alt='rightClick' width={20} height={20}/>
                                                                <p className='font-medium text-lightBlack opacity-80 text-lg sm:text-xl md:text-2xl leading-130'>Market Analysis</p>
                                                        </div>
                                                        <div className='flex items-center gap-[10px] '>
                                                                <Image src="/assets/images/blockdetail/svg/right-click.svg" alt='rightClick' width={20} height={20}/>
                                                                <p className='font-medium text-lightBlack opacity-80 text-lg sm:text-xl md:text-2xl leading-130'>Marketing Strategy</p>
                                                        </div>
                                                        <div className='flex items-center gap-[10px] '>
                                                                <Image src="/assets/images/blockdetail/svg/right-click.svg" alt='rightClick' width={20} height={20}/>
                                                                <p className='font-medium text-lightBlack opacity-80 text-lg sm:text-xl md:text-2xl leading-130'>Operational Plan</p>
                                                        </div>
                                                        <div className='flex items-center gap-[10px]'>
                                                                <Image src="/assets/images/blockdetail/svg/right-click.svg" alt='rightClick' width={20} height={20}/>
                                                                <p className='font-medium text-lightBlack opacity-80 text-lg sm:text-xl md:text-2xl leading-130'>Financial Plan</p>
                                                        </div>
                                                </div>
